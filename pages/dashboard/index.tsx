        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Tractors need immediate service</p>
            </CardContent>
          </Card>
        </div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <div className="flex justify-between text-sm mb-1">
                          ...
                          <span className="font-medium">{tractor.hours}/60</span>
                        </div>
                        <Progress
          ...
          <TabsContent value="notifications">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Stay updated on your tractor maintenance</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {[
